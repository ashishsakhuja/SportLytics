      ...
      ? createPortal(
          ...
          >
            <div
              ...
              style={{
                maxHeight:
                  "calc(100dvh - max(1.5rem, env(safe-area-inset-top) + env(safe-area-inset-bottom)))",
              }}
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-3 max-w-3xl text-sm leading-6 text-white/70 sm:text-[15px]">
                      Before entering the dashboard, please review and accept the
                      current SportLytics platform terms. This notice explains how
                      the platform uses third-party sports data, news feeds, and
                      AI-generated features, along with the standards expected in
                      community spaces.
                    </p>
                  </div>
                  <button
                  ...
                  <div className="space-y-6">
                    <section className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5">
                      <h3 className="text-lg font-semibold text-white">
                        1. Platform use and important disclaimers
                      </h3>
                      <div className="mt-3 space-y-3 text-sm leading-7 text-white/72">
                        <p>
                          SportLytics is an analytics, visualization, community,
                          and AI-assisted sports experience. By continuing, you
                          acknowledge that platform content is provided for
                          informational, educational, and entertainment purposes
                          only.
                        </p>
                        <p>
                          SportLytics does not guarantee that every chart, article,
                          feed item, score, advanced metric, AI-generated
                          explanation, or community post is complete, current,
                          error-free, uninterrupted, or suitable for any specific
                          decision.
                        </p>
                        <p>
                          Nothing on SportLytics should be relied upon as legal,
                          financial, betting, gambling, medical, or professional
                          advice. You remain solely responsible for how you
                          interpret and use platform content.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5">
                      <h3 className="text-lg font-semibold text-white">
                        2. Data sources, APIs, and attribution
                      </h3>
                      <div className="mt-4 space-y-4 text-sm leading-7 text-white/72">
                        ...
                        <p>
                          Third-party names, logos, marks, headlines, league
                          references, and source materials belong to their
                          respective owners. SportLytics does not claim ownership
                          of external league data, publisher content, or linked
                          articles unless expressly stated.
                        </p>
                        <p>
                          Source availability, rate limits, format changes,
                          licensing restrictions, endpoint updates, or provider
                          outages may affect platform functionality, historical
                          completeness, and freshness of displayed information.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5">
                      <h3 className="text-lg font-semibold text-white">
                        3. AI-generated insights and Pulse usage
                      </h3>
                      <div className="mt-3 space-y-3 text-sm leading-7 text-white/72">
                        <p>
                          Pulse responses, chart captions, chart Q&amp;A, and
                          other AI-assisted outputs may summarize trends, compare
                          teams, or convert structured data into natural language.
                          These outputs can be helpful, but they may occasionally
                          be incomplete, stale, approximate, or incorrect.
                        </p>
                        <p>
                          By using AI features, you understand that generated text
                          should be verified against the underlying chart, article,
                          table, or source context before being relied upon or
                          shared as fact.
                        </p>
                        <p>
                          You may not use SportLytics AI features to generate
                          abusive, harassing, illegal, fraudulent, or misleading
                          content, or to intentionally produce harmful prompts or
                          community content.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5">
                      <h3 className="text-lg font-semibold text-white">
                        4. User content, sharing, and moderation
                      </h3>
                      <div className="mt-3 space-y-3 text-sm leading-7 text-white/72">
                        <p>
                          If you share charts, write posts, reply in discussions,
                          or interact in community features, you are responsible
                          for the accuracy, tone, legality, and appropriateness of
                          your submissions.
                        </p>
                        <p>
                          SportLytics may remove, restrict, review, or moderate
                          content that appears abusive, deceptive, infringing,
                          spammy, unsafe, or otherwise inconsistent with platform
                          rules or community health.
                        </p>
                        <p>
                          Repeated or severe violations may lead to content
                          removal, temporary restrictions, or loss of access to
                          certain platform areas.
                        </p>
                      </div>
                    </section>
                  </div>
                  ...
                  <div className="space-y-6">
                    <section className="rounded-[24px] border border-fuchsia-400/15 bg-fuchsia-500/[0.04] p-5">
                      ...
                      <p className="mt-3 text-sm leading-7 text-white/72">
                        SportLytics is intended to be sharp, insightful, and
                        competitive without becoming hostile. By joining community
                        areas, you agree to uphold the following standards:
                      </p>
                    ...
                    <section className="rounded-[24px] border border-cyan-400/15 bg-cyan-500/[0.04] p-5">
                      ...
                      <div className="mt-3 space-y-3 text-sm leading-7 text-white/72">
                        <p>
                          Do not post sensitive personal data, private
                          conversations, payment information, or anything you would
                          not want publicly associated with your name or profile.
                        </p>
                        <p>
                          You are responsible for protecting your own device,
                          browser session, and any account credentials associated
                          with your access to SportLytics.
                        </p>
                        <p>
                          SportLytics may store preference, session, or acceptance
                          state locally in your browser to improve usability,
                          including remembering acceptance of this agreement.
                        </p>
                      </div>
                    </section>
                      ...
                      <div className="mt-4 space-y-4 text-sm text-white/80">
                        <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                          ...
                          <span className="leading-6">
                            I have reviewed and accept the SportLytics Terms of
                            Service, platform disclaimers, AI-use notice, and
                            source attribution information above.
                          </span>
                        </label>
                        ...
                        <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                          ...
                          />
                          <span className="leading-6">
                            I agree to follow the SportLytics community
                            guidelines, engage respectfully, avoid harassment or
                            abusive language, and use shared spaces responsibly.
                          </span>
                        </label>
                      </div>
                    </section>
              ...
              >
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <p className="max-w-3xl text-xs leading-6 text-white/50">
                    By selecting continue, you acknowledge this agreement and
                    understand it may be updated as SportLytics features, data
                    providers, community tools, and AI capabilities evolve.
                  </p>
    ...
    <>
      <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-0 right-0 top-0 z-[2] h-16 opacity-80">
          ...
          <motion.div className="absolute inset-0 z-[0]" style={{ x: sx, y: sy }}>
            <motion.div
              className="absolute -left-52 -top-32 h-[600px] w-[800px] blur-2xl opacity-70"
              style={{
                background:
            ...
            <motion.div
              className="absolute -right-52 -top-32 h-[600px] w-[800px] blur-2xl opacity-70"
              style={{
                background:
            ...
            <motion.div
              className="absolute right-[10%] top-0 h-[700px] w-[700px] rounded-full blur-3xl opacity-80 mix-blend-screen"
              style={{
                background:
          ...
          <div className="absolute bottom-0 left-0 right-0 z-[1] h-[380px]">
            <div
            ...
            <div className="absolute inset-0">
              <div className="absolute bottom-14 left-8 flex select-none gap-8 font-extrabold tracking-widest text-white/70">
                {["10", "20", "30", "40"].map((n) => (
                  <span
                    key={n}
              ...
              <div className="absolute bottom-14 right-8 flex select-none gap-8 font-extrabold tracking-widest text-white/70">
                {["40", "30", "20", "10"].map((n) => (
                  <span
                    key={n}
                    className="text-4xl drop-shadow-[0_0_18px_rgba(255,255,255,0.35)]"
        ...
        <section className="relative z-[3] flex min-h-screen items-center justify-center px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-white/70 sm:text-base">
              A modern sports analytics platform for exploring league trends,
              asking smarter questions, building custom charts, following news,
              and turning raw numbers into readable insight.
            </p>
        ...
        <section
          id="about"
          className="relative z-[3] border-t border-white/10 bg-[#05070c]/90 px-6 py-20 backdrop-blur-sm sm:py-24"
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {featureCards.map((card) => (
                <div
                  key={card.title}
                  className="rounded-[24px] border border-white/10 bg-white/[0.04] p-5 shadow-[0_14px_40px_rgba(0,0,0,0.22)]"
                >
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="rounded-[28px] border border-fuchsia-400/18 bg-gradient-to-br from-fuchsia-500/[0.08] via-white/[0.03] to-cyan-500/[0.04] p-7 shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
                ...
                <div className="mt-8 grid gap-3">
                  {premiumItems.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-sm leading-7 text-white/76"
                    >
                      {item}
                    </div>
                  ))}
              ...
              <div className="rounded-[28px] border border-white/10 bg-white/[0.04] p-7">
                ...
                <p className="mt-4 text-sm leading-7 text-white/72">
                  Instead of using one site for standings, another for charts,
                  another for stories, and another for opinions, SportLytics is
                  built to connect those layers. Premium pushes that concept
                  further by giving users a more complete analytics environment
                ...
                <div className="mt-8 rounded-[24px] border border-white/10 bg-black/25 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/70">
                    Power users, content creators, fantasy players, sports
                    researchers, and fans who want cleaner workflows and better
                    sports intelligence than a standard stats page can provide.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="relative z-[3] border-t border-white/10 bg-[#05070c] px-6 py-20 sm:py-24">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <div className="mt-8 space-y-4">
                {sourceCredits.map((item) => (
                  <div
                    key={item}
                    className="rounded-[22px] border border-white/10 bg-white/[0.04] p-4 text-sm leading-7 text-white/72"
                  >
                    {item}
                  </div>
                ))}
            ...
            <div className="rounded-[28px] border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.02] p-7">
              ...
              <h3 className="mt-3 text-2xl font-semibold text-white">
                Data, news, and AI are all different layers
              </h3>
              <p className="mt-4 text-sm leading-7 text-white/72">
                Scores and statistics may refresh on different timelines than
                article feeds. AI-generated summaries may lag or simplify what the
                raw data shows. That is why SportLytics is strongest when users
                combine the charts, sources, and written explanations together.
              </p>
              <div className="mt-8 rounded-[24px] border border-cyan-400/15 bg-cyan-500/[0.05] p-5 text-sm leading-7 text-white/74">
                External source names such as ESPN, NFL.com, Yahoo Sports, and CBS
                Sports are used for attribution and credit. SportLytics is a
                separate product experience layered on top of sourced data and
                linked content.
              </div>
            </div>
          </div>
        ...
        <section className="relative z-[3] border-t border-white/10 bg-[#04060a] px-6 py-20 sm:py-24">
          <div className="mx-auto max-w-6xl rounded-[30px] border border-white/10 bg-gradient-to-r from-cyan-500/[0.08] via-white/[0.03] to-fuchsia-500/[0.08] p-8 text-center shadow-[0_18px_60px_rgba(0,0,0,0.28)] sm:p-10">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-sm leading-7 text-white/72 sm:text-base">
              Browse the dashboards, compare teams, follow news, and use Pulse to
              ask smarter sports questions. When you are ready, continue into the
